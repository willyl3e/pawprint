  ...
  return (
    <>
      ...
      <div className="bg-blue-50">
        ...
        <div className=" ml-[20%] mr-[20%] border-l border-r border-blue-300 grid grid-cols-2">
          <Link href="/puzzles/connections">
            <div className="bg-white text-center p-8 border-blue-300 border-r hover:scale-110 hover:border-blue-300 hover:border transition delay-150 hover:cursor-pointer">
              ...
              <span className="block text-3xl tracking-tighter">
                Connections
              </span>
              <span className="inter text-gray-400 tracking-tighter">
