...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <div className="bg-blue-50 border-b-blue-300 border-b-[1px]">
        <nav className="nav bg-blue-50 border-l-blue-300 border-r-blue-300 border-[1px] pt-3 pb-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="30px"
            viewBox="0 -960 960 960"
          ...
          <div>
            <Link href="/search">
              <svg
                ...
                width="30px"
                fill="#1155cc"
                className="place-self-end mr-10"
              >
